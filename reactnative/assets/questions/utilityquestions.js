export const utilityquestions = [
  {
    ...
    options: [
      { id: 1, text: 'One', carbon_footprint: 0.085, next_question: 2 },
      { id: 2, text: 'Two', carbon_footprint: 0.17, next_question: 2 },
      { id: 3, text: 'Three', carbon_footprint: 0.255, next_question: 2 },
      {
        id: 4,
